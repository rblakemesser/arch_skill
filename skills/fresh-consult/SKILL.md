...
opinions from Claude Fable/Opus, Codex GPT/GBT models or Fugu profiles, Cursor Composer, or Grok
...
- The user asks Cursor Agent to run GPT/GBT model ids, Fugu profiles, or Claude
  models. Cursor Agent is Composer-only; GPT/GBT model ids and Fugu profiles
  run through Codex, and Claude models run through Claude Code.
- The user asks Grok to run GPT/GBT model ids, Fugu profiles, Claude, or
  Cursor-only model ids. Grok uses `grok-build` or `grok-composer-2.5-fast`.
