...
Run repeated strong real-app automation audit passes until the exhaustive map is complete and a fresh review says no credible major unresolved automation risk remains, or the loop is genuinely blocked.
...
- `auto` must not skip exhaustive mapping just to land a quick lane tweak
