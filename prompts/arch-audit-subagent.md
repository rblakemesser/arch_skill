...
---
# /prompts:arch-audit-subagent — $ARGUMENTS
...
- The subagent may inspect code, but the only file edits are to DOC_PATH (inserting the audit block).
- Do not implement fixes here; record them as gaps in the doc.
