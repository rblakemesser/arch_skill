...
SKILLS := arch-step miniarch-step arch-docs arch-mini-plan lilarch bugs-flow audit-loop comment-loop audit-loop-sim goal-loop north-star-investigation arch-flow arch-skills-guide arch-loop delay-poll wait agent-definition-auditor agents-md-authoring prompt-authoring skill-authoring eli10 pr-authoring skill-flow amir-publish codex-review-yolo fresh-consult agent-delegate model-consensus code-review stepwise arch-epic
CLAUDE_SKILLS := arch-step miniarch-step arch-docs arch-mini-plan lilarch bugs-flow audit-loop comment-loop audit-loop-sim goal-loop north-star-investigation arch-flow arch-skills-guide arch-loop delay-poll wait agent-definition-auditor agents-md-authoring prompt-authoring skill-authoring eli10 pr-authoring skill-flow amir-publish codex-review-yolo fresh-consult agent-delegate model-consensus code-review stepwise arch-epic
GEMINI_SKILLS := arch-step miniarch-step arch-docs arch-mini-plan lilarch bugs-flow audit-loop comment-loop audit-loop-sim goal-loop north-star-investigation arch-flow arch-skills-guide agent-definition-auditor agents-md-authoring prompt-authoring skill-authoring eli10 pr-authoring skill-flow amir-publish codex-review-yolo fresh-consult agent-delegate model-consensus stepwise arch-epic
